...
#pivot_table.to_csv('75annualpivot_table_enso_iod.csv')
print(pivot_table)
#print("The +1SD value for NINO 3.4 SST Anomalies is:", 0.75*nino_sd)
#print("The +1SD value for DMI is:", 0.75*dmi_sd)

#print(df_year.columns)
#df_year.to_csv('75annualyears_classified.csv')
